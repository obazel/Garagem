 ...
 */
public class GeradorDeContraChequeGerente extends javax.swing.JFrame {

    /**
     * Creates new form CalculaFuncionario
     */
    public GeradorDeContraChequeGerente() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel8.setText("SELECIONE O GERENTE");
        ...
        botaoCalcular.setBackground(new java.awt.Color(255, 255, 255));
        botaoCalcular.setForeground(new java.awt.Color(153, 0, 0));
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addComponent(botaoCalcular, javax.swing.GroupLayout.PREFERRED_SIZE, 37, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private void botaoCalcularMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_botaoCalcularMouseClicked
            ...
            if(Cadastramento.procuraGerenteNome(caixaFuncionario.getSelectedItem().toString()) instanceof model.Gerente){
            Cadastramento.calculaSalario(Cadastramento.procuraGerenteNome(caixaFuncionario.getSelectedItem().toString()), caixaMes.getSelectedIndex()+1, Integer.parseInt(caixaAno.getSelectedItem().toString()));

            paneSalario.setText("|-----------CONTRACHEQUE-----------|\n" + "Funcionário: " + Cadastramento.procuraGerenteNome(caixaFuncionario.getSelectedItem().toString()) + "\n\nPeríodo de referência: " + caixaMes.getSelectedItem() + "/" + caixaAno.getSelectedItem().toString() +"\n\nSalário: " + Cadastramento.procuraGerenteNome(caixaFuncionario.getSelectedItem().toString()).getSalario());
            ...
            //Criando arquivo de contracheque
                try {
                    ...
                    gravar.printf("|-----------CONTRACHEQUE-----------|%n" + "Funcionário: " + Cadastramento.procuraGerenteNome(caixaFuncionario.getSelectedItem().toString()) + "%n%nPeríodo de referência: " + caixaMes.getSelectedItem() + "/" + caixaAno.getSelectedItem().toString() +"%n%nSalário: " + Cadastramento.procuraGerenteNome(caixaFuncionario.getSelectedItem().toString()).getSalario());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GeradorDeContraChequeGerente.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new GeradorDeContraChequeGerente().setVisible(true);
            }
        });
    }
